...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="uploadinterior">
        <div class="upload-container">
            <div>
              <div class="card my-2 p-2" id="p-2">
                <div style="text-align:center"> 
                    <form class="subform"  method="post" action="{{route('addInterior')}}" enctype="multipart/form-data">
                    @csrf <!-- very important if you didn't insert CSRF, it not allow submit the data-->
                    <p>
                        <label for="design" class="label">Name</label><br>
                        <input type="text" name="design" id="design" required>
                    </p>
                    <p>
                        <label for="skill" class="label">Skill</label><br>
                        <input type="text" name="skill" id="skill" required>
                    </p>
                    <p>
                       <label for="experience" class="label">Experience</label><br>
                       <input type="number" name="experience" id="experience" required>
                        
                    </p>
                    <p>
                        <label for="certificate" class="label">Certificate</label><br>
                        <input type="text" name="certificate" id="certificate" required>
                    </p>
                    
                    <p>
                        <input type="file" class="form-control" name="image-img" value="" required>
                    </p>
                    <p> 
